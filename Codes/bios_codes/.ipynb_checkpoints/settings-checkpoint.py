...
DATA_DIR = Path(os.environ.get('BIAS_DATA_DIR', './../BiosBias/DE/'))
CACHE_DIR = DATA_DIR.joinpath('cache_gender_balanced')
# CACHE_DIR = DATA_DIR.joinpath('cache_8l')
MODEL_DIR = Path(
    os.environ.get('BIOS_MODEL_DIR', './../BiosBias/DE/cache_gender_balanced'))
EMB_DIR = Path(
